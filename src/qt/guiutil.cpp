...
{
    return GetSpecialFolderPath(CSIDL_STARTUP) / "CAT.lnk";
}
...
{
    return GetAutostartDir() / "CAT.desktop";
}
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("CAT-Qt") + " " + tr("version") + " " +
        QString::fromStdString(FormatFullVersion()) + "\n\n" +
        tr("Usage:") + "\n" +
        "  CAT-qt [" + tr("command-line options") + "]                     " + "\n";
