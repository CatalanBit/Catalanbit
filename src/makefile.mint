...
test check: test_CATALANBIT FORCE
	./test_CATALANBIT
...
CATALANBITd: leveldb/libleveldb.a \
...
test_CATALANBIT: $(TESTOBJS) $(filter-out obj/init.o,$(OBJS:obj/%=obj/%))
	$(CXX) $(CFLAGS) -o $@ $(LIBPATHS) $^ $(LIBS) $(TESTLIBS)


clean:
	-rm -f CATALANBITd test_CATALANBIT
	-rm -f obj/*.o
	-rm -f obj-test/*.o
	-rm -f obj/*.P
	-rm -f obj-test/*.P
